...
- [Amtrak Routes from USDOT BTS](https://data-usdot.opendata.arcgis.com/datasets/amtrak-routes/): GIS data for Amtrak routes.
- [Amtrak Schedule](https://www.railpassengers.org/resources/amtrak-timetables/): Schedule PDFs from RPA
- [Amtrak & VIA Status Maps](https://asm.transitdocs.com/): Real-time train status maps.
