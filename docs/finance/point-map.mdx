...
flowchart LR
    ...
    DL([Delta SkyMiles])
    AS([Alaska Hawaiian Atmos Rewards])
    ...
    LYFT{{Lyft}}
    LYFT -- <a href="https://help.lyft.com/hc/en-us/all/articles/4546040548-Alaska-Airlines-and-Lyft-partnership" target="_blank" rel="noopener noreferrer">2-3 Points/$</a> --> AS
    LYFT -- <a href="https://help.lyft.com/hc/en-us/all/articles/5808341311-united-mileageplus" target="_blank" rel="noopener noreferrer">1-4 Miles/$</a> --> UA
