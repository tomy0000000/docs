...
- [resumes.fyi](https://resumes.fyi/): A collection of software engineering resumes that landed interviews at top tech companies.
- [CookedCareer](https://www.cookedcareer.com/): likewise, but with paywall.

## References

- [Reddit](https://www.reddit.com/r/csMajors/comments/1ohk6j0/24k_upvotes_and_150_dms_later_now_i_know_why/)
