...
- <abbr title="Paid time off">PTO</abbr>- Quota, accrual, and usage - Request
  and approval process
- Savings Account
  - <abbr title="401(k)">401k</abbr> / <abbr title="403(b)">403b</abbr>
  - <abbr title="Health Savings Account">HSA</abbr> / <abbr title="Flexible Spending Account">FSA</abbr>
- Benefits
...
- Identify the go-to persons
  ...
  - **Exploratory**: Ask colleagues who should I know, and why? then recusively repeat.
...
- Develop communication plan
  ...
  - What are the biggest takeaways from them? (domain knowledge, specific strength, gossip?)
